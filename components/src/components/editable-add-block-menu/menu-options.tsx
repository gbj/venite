...
export const MENU : MenuOption[] = [
  {
    ...
    template: [
      new LiturgicalDocument({ type: 'heading', label: 'Anthem', citation: '', value: [''] }),
      new LiturgicalDocument({ type: 'text', metadata: { omit_response: true }, value: [''] })
    ]
  },
  {
    label: 'bible',
  ...
  },
  {
    ...
    template: [
      new LiturgicalDocument({ type: 'heading', label: 'Hymn', citation: '', value: [''] }),
    ]
  },
  {
    label: 'meditation',
  ...
  },
  {
    ...
    template: [ new LiturgicalDocument({ type: 'responsive', style: 'litany', value: [ { label: '', text: '', response: '' } ] }) ]
  },
  {
    label: 'prayer',
    section: ['Prayer'],
  ...
  },
  {
    ...
    template: [ new LiturgicalDocument({ type: 'responsive', style: 'preces', value: [ { label: '', text: '', response: '' } ] }) ]
  },
  {
    label: 'responsive',
    section: ['Prayer'],
    ...
    template: [ new LiturgicalDocument({ type: 'responsive', style: 'responsive', value: [ { label: '', text: '', response: '' } ] }) ]
  },
  {
    label: 'rubric',
    section: ['Liturgy'],

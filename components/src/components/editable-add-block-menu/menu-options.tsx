...
import { LiturgicalDocument, Text, BibleReading, Option, Meditation, Heading, ResponsivePrayer, Rubric, Psalm, Refrain, Liturgy, Image, Parallel } from '@venite/ldf';
...
export const MENU : MenuOption[] = [
  ...
  },
  {
    label: 'parallels',
    section: ['Liturgy'],
    /* SVG is Font Awesome 'fa-pause' */
    icon: () => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M48 64C21.5 64 0 85.5 0 112L0 400c0 26.5 21.5 48 48 48l32 0c26.5 0 48-21.5 48-48l0-288c0-26.5-21.5-48-48-48L48 64zm192 0c-26.5 0-48 21.5-48 48l0 288c0 26.5 21.5 48 48 48l32 0c26.5 0 48-21.5 48-48l0-288c0-26.5-21.5-48-48-48l-32 0z"/></svg>    ),
    template: [
      new Parallel({
        "type": "parallel",
        "value": [
          new Text({ type: 'text', style: 'text', value: [''] }),
          new Text({ type: 'text', style: 'text', value: [''] })
        ]
      })
    ]

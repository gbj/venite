...
| `parentType` | `parent-type` | Type of the parent `LiturgicalDocument`, if any                                                                      | `"bible-reading" \| "cycle" \| "heading" \| "liturgy" \| "meditation" \| "option" \| "parallel" \| "psalm" \| "refrain" \| "responsive" \| "rubric" \| "text"` | `undefined` |

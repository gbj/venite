...
| -------- | --------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `lookup` | --        | Starting value for editing                            | `{ type: string; table?: string \| { preference: string; }; item?: string \| number \| { preference: string; }; filter?: "seasonal" \| "evening" \| "day"; rotate?: boolean; }` | `undefined` |

...
import { BibleReading, LiturgicalDocument, ResponsivePrayer, Text, } from "../../ldf/src";
import { Cursor, } from "./components/editable-text/cursor";
import { TextEdit, } from "./components/editable-text/text-edit";
...
export namespace Components {
    ...
    interface LdfEditableText {
        ...
        "placeholder": string;
        /**
          * Reduces the list of edits triggered by input events to as few contiguous edits as possible. and emits it as a `textEdited` event
         */
    ...
    interface LdfString {
         ...
         */
        "citation": string | SelectableCitation;
        /**
...
declare namespace LocalJSX {
    ...
    interface LdfEditableText {
        ...
        "onTextEdited"?: (event: CustomEvent<TextEdit[]>) => void;
        /**
          * A JSON Pointer that points to the Collect being edited
         */
        "path"?: string;

...
import { CanticleTableServiceInterface } from './canticle-table-service.interface';
...
export const CANTICLE_TABLE_SERVICE = new InjectionToken<CanticleTableServiceInterface>('CanticleTableService');

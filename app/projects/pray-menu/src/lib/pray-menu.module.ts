...
@NgModule({
  declarations: [LiturgySelectComponent, LiturgyPreferenceMenuComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
  ...
  exports: [LiturgySelectComponent, LiturgyPreferenceMenuComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class PrayMenuModule {
  public static forRoot(
    args: PrayMenuRootConfig
  ): ModuleWithProviders<PrayMenuModule> {
    return {

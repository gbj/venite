...
import { OrganizationService, Organization } from 'src/app/organization/organization.module';
...
export class SharingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.privacyOptions = [
      ...
      { value: 'organization', label: this.translate.instant('editor.organization-access') },

[@venite/ldf](../README.md) › [Globals](../globals.md) › ["utils/unwrap-options"](_utils_unwrap_options_.md)
...
*Defined in [utils/unwrap-options.ts:5](https://github.com/gbj/venite/blob/9259d3f6/ldf/src/utils/unwrap-options.ts#L5)*

...
• **FAKE_SEASONS**: *string[]* = ['Saints', 'Mary', 'Ember', 'National', 'Rogation']

*Defined in [utils/find-collect.ts:8](https://github.com/gbj/venite/blob/3f1ddc3/ldf/src/utils/find-collect.ts#L8)*
...
*Defined in [utils/find-collect.ts:11](https://github.com/gbj/venite/blob/3f1ddc3/ldf/src/utils/find-collect.ts#L11)*
...
*Defined in [utils/find-collect.ts:62](https://github.com/gbj/venite/blob/3f1ddc3/ldf/src/utils/find-collect.ts#L62)*

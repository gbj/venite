...
*Defined in [canticle-table/filter-canticle-table-entries.ts:5](https://github.com/gbj/venite/blob/def118c/ldf/src/canticle-table/filter-canticle-table-entries.ts#L5)*

...
*Defined in [canticle-table/filter-canticle-table-entries.ts:5](https://github.com/gbj/venite/blob/cd2de20/ldf/src/canticle-table/filter-canticle-table-entries.ts#L5)*

...
*Defined in [canticle-table/filter-canticle-table-entries.ts:6](https://github.com/gbj/venite/blob/d1a46fe/ldf/src/canticle-table/filter-canticle-table-entries.ts#L6)*

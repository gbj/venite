...
\+ **new DisplaySettings**(`dropcaps`: "decorated" | "plain" | "none", `response`: "bold" | "italics", `repeatAntiphon`: "bracket" | "repeat" | "none", `fontscale`: "s" | "m" | "l" | "xl" | "xxl", `font`: "garamond" | "gill-sans", `voiceChoice`: string, `voiceRate`: number, `voiceBackground`: "silence" | "seashore" | "garden" | "night" | "silence-short", `voiceBackgroundVolume`: number, `psalmVerses`: boolean, `bibleVerses`: boolean, `meditationBell`: "silence" | "singing-bowl", `darkmode`: "auto" | "dark" | "light", `bolded`: "both" | "unison" | "response" | "none", `psalmPause`: number): *[DisplaySettings](_display_settings_.displaysettings.md)*

*Defined in [display-settings.ts:1](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L1)*
...
*Defined in [display-settings.ts:13](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L13)*
...
*Defined in [display-settings.ts:16](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L16)*
...
*Defined in [display-settings.ts:15](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L15)*
...
*Defined in [display-settings.ts:3](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L3)*
...
*Defined in [display-settings.ts:7](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L7)*
...
*Defined in [display-settings.ts:6](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L6)*
...
*Defined in [display-settings.ts:14](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L14)*
...
*Defined in [display-settings.ts:17](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L17)*
...
*Defined in [display-settings.ts:12](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L12)*
...
*Defined in [display-settings.ts:5](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L5)*
...
*Defined in [display-settings.ts:4](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L4)*
...
*Defined in [display-settings.ts:10](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L10)*
...
*Defined in [display-settings.ts:11](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L11)*
...
*Defined in [display-settings.ts:8](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L8)*
...
*Defined in [display-settings.ts:9](https://github.com/gbj/venite/blob/2e86b2f0/ldf/src/display-settings.ts#L9)*
